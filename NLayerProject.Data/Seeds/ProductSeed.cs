    ...
    class ProductSeed:IEntityTypeConfiguration<Product>
    {
        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 3, Name = "Tükenmez Kalem", Price = 32.50m, Stock = 10, CategoryId = _ids[0] },
                new Product { Id = 4, Name = "Küçük Boy Defter", Price = 12.50m, Stock = 100, CategoryId = _ids[1] },
                new Product { Id = 5, Name = "Orta Boy Defter", Price = 22.50m, Stock = 100, CategoryId = _ids[1] },
                new Product { Id = 6, Name = "Büyük Boy Defter", Price = 32.50m, Stock = 100, CategoryId = _ids[1] }
                );
        }
    }
}
